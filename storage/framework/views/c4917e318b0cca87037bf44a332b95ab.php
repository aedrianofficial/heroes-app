                                ...
                                <tr>
                                    ...
                                    <td class="action-btns" data-label="View">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <div class="d-inline">
                                                <a href="<?php echo e(route('pnp.emergencymessage.view', $message->id)); ?>"
                                    ...
                                    <td class="action-btns" data-label="Actions">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <form id="respondedForm-<?php echo e($message->id); ?>"
                                                action="<?php echo e(route('pnp.emergencymessage.responded', $message->id)); ?>"
                                            ...
                                            <form id="completeForm-<?php echo e($message->id); ?>"
                                                action="<?php echo e(route('pnp.emergencymessage.complete', $message->id)); ?>"
                                                method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="button"
...
<?php echo $__env->make('layouts.pnp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/pnp/emergency-messages/index.blade.php ENDPATH**/ ?>