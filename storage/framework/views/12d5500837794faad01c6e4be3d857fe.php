                                ...
                                <tr>
                                    ...
                                    <td class="action-btns" data-label="View">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <div class="d-inline">
                                                <a href="<?php echo e(route('lgu.emergencycall.view', $call->id)); ?>"
...
<?php echo $__env->make('layouts.lgu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/lgu/emergency-calls/index.blade.php ENDPATH**/ ?>