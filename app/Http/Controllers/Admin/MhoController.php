...
class MhoController extends Controller
{
    public function mhoDashboard()
    {
        ...
        $agencies = Agency::all();
        return view('admin.mho.dashboard', compact('totalReports', 'pendingReports', 'completedReports','respondedReports', 'reports','agencies'));
    }
    ...
    public function storeReport(Request $request){
        ...
        return redirect()->route('mho.reports.index')->with('success', 'Report marked as responded.');
    }
    ...
    public function callCaseLists()
    {
        ...
        return view('admin.mho.call-cases.index', compact('calls'));
    }
    public function messageCaseLists()
    {
        ...
        return view('admin.mho.message-cases.index', compact('messages'));
    }
  /**
