            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="<?php echo e(route('bfp.emergencycall.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.bfp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/bfp/emergency-calls/view.blade.php ENDPATH**/ ?>