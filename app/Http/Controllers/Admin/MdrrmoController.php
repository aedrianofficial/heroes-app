...
class MdrrmoController extends Controller
{
    public function mdrrmoDashboard()
    {
        ...
        return view('admin.mdrrmo.dashboard', compact('totalReports', 'pendingReports', 'completedReports','ongoingReports', 'reports'));
    }
    ...
    public function storeReport(Request $request){
        ...
        return redirect()->route('mdrrmo.reports.index')->with('success', 'Report marked as ongoing.');
    }
    ...
    public function viewEmergencyMessage($id)
    {
        ...
        return view('admin.mdrrmo.emergency-messages.view', compact('message'));
    }
