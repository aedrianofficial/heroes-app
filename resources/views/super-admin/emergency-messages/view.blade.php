            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="{{ route('superadmin.emergencymessage.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <div class="d-flex gap-2">
                            <form id="respondedForm-{{ $message->id }}"
                                action="{{ route('superadmin.emergencymessage.responded', $message->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                            ...
                            <form id="completeForm-{{ $message->id }}"
                                action="{{ route('superadmin.emergencymessage.complete', $message->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                        ...
                                        <div class="modal fade" id="generateReportModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form
                                                        action="{{ route('superadmin.incident_reports.generate.with_source', ['id' => $message->id, 'source_type' => 'message']) }}"
                                                        method="GET">
                                                    ...
                                                    @foreach ($reportsInfo as $reportInfo)
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('superadmin.incident_reports.view', $reportInfo['id']) }}"
                                                                target="_blank">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('superadmin.incident_reports.download', $reportInfo['id']) }}">
