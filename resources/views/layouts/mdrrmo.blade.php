        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('admin.mdrrmo') }}">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('mdrrmo.incident_reports.index') }}">Reports</a>
                    </li>
                    {{-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('mdrrmo.reports.create') }}">Create a Report</a>
                            </li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('mdrrmo.emergencymessage.index') }}">Message
                                    logs</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('mdrrmo.emergencycall.index') }}">Call logs</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
