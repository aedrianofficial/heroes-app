...
/**
    ...
    public function list()
    {
        ...
        return view('super-admin.incidents.list', compact('reports'));
    }
    ...
    protected function generateCallReport(Request $request, $callId)
    {
        ...
        return view('super-admin.incidents.index', [
            'call' => $call,
            'message' => null,
            'reports' => $reports,
            'source_type' => 'call'
    ...
    protected function processIncidentCases(Request $request, $incidentCases, $call = null, $message = null)
    {
        ...
        foreach ($incidentCases as $case) {
            ...
            if (!$report) {
                ...
                $pdfContent = view('super-admin.incidents.view', $viewData)->render();
