...
namespace App\Http\Controllers\Coastguard;
...
class IncidentReportController extends Controller
{
   /**
    ...
    public function list()
    {
        ...
        return view('admin.coastguard.incidents.list', compact('reports'));
    }
    ...
    protected function generateCallReport(Request $request, $callId)
    {
        ...
        return view('admin.coastguard.incidents.index', [
            'call' => $call,
            'message' => null,
            'reports' => $reports,
            'source_type' => 'call'
    ...
    protected function processIncidentCases(Request $request, $incidentCases, $call = null, $message = null)
    {
        ...
        foreach ($incidentCases as $case) {
            ...
            if (!$report) {
                ...
                $pdfContent = view('admin.coastguard.incidents.view', $viewData)->render();
