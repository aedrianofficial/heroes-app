            ...
            <div class="col-lg-10">
                <div class="card shadow-lg mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <p class="text-dark"><?php echo e($report->name); ?></p>
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="<?php echo e(route('superadmin.reports.index')); ?>" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <div class="d-flex gap-2">
                            <form action="<?php echo e(route('superadmin.reports.responded', $report->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" onclick="confirmResponded(event)" class="btn btn-sm btn-warning">Mark
                                    as Responded</button>
                            </form>
                            <form action="<?php echo e(route('superadmin.reports.complete', $report->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/super-admin/report/view.blade.php ENDPATH**/ ?>