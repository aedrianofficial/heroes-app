                    ...
                    <tbody>
                        @foreach ($messages as $message)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('pnp.emergencymessage.ongoing', $message->id) }}" method="POST">
                                        @csrf
                                ...
                                <td>
                                    <form action="{{ route('pnp.emergencymessage.complete', $message->id) }}"
                                        method="POST">
                                        @csrf
        ...
        function confirmOngoing(event, formId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Append the log details to the form dynamically
