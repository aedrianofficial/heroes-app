                                ...
                                <tr>
                                    ...
                                    <td class="action-btns" data-label="View">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <div class="d-inline">
                                                <a href="<?php echo e(route('coastguard.emergencycall.view', $call->id)); ?>"
                                    ...
                                    <td class="action-btns" data-label="Actions">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <form id="respondedForm-<?php echo e($call->id); ?>"
                                                action="<?php echo e(route('coastguard.emergencycall.responded', $call->id)); ?>"
                                            ...
                                            <form id="completeForm-<?php echo e($call->id); ?>"
                                                action="<?php echo e(route('coastguard.emergencycall.complete', $call->id)); ?>"
                                                method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.coastguard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/coastguard/call-cases/index.blade.php ENDPATH**/ ?>