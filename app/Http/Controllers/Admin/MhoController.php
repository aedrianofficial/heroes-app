...
class MhoController extends Controller
{
    public function mhoDashboard()
    {
        ...
        return view('admin.mho.dashboard', compact('totalReports', 'pendingReports', 'completedReports','ongoingReports', 'reports'));
    }
    ...
    public function viewEmergencyMessage($id)
    {
        ...
        return view('admin.mho.emergency-messages.view', compact('message'));
    }
