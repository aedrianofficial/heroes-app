                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <form id="completeForm-<?php echo e($message->id); ?>"
                                ...
                                <?php echo csrf_field(); ?>
                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                    title="<?php echo e($message->status_id == 3 ? 'This case is already completed' : ($message->requests->isEmpty() ? 'No requests to complete' : ($message->can_complete ? 'Mark as Complete' : 'Required agencies must respond first'))); ?>">
                                    <button type="button"
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/super-admin/emergency-messages/view.blade.php ENDPATH**/ ?>