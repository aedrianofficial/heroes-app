                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('bfp.message_cases.index')); ?>">Cases</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('bfp.emergencycall.index')); ?>">Call logs</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="<?php echo e(route('bfp.call_cases.index')); ?>">Cases</a></li>
                        </ul>
                    </li>
                    <!--<li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?php echo e(route('bfp.reports.index')); ?>">Activity
                            Logs</a>
                    </li>-->
                </ul>
...
<?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/layouts/bfp.blade.php ENDPATH**/ ?>