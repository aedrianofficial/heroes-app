...
class SuperAdminController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        public function storeReport(Request $request){
            ...
            return redirect()->route('superadmin.reports.index')->with('success', 'Report marked as responded.');
        }
        ...
        public function callCaseLists()
     {
         ...
         return view('super-admin.call-cases.index', compact('calls'));
     }
     ...
     public function messageCaseLists()
     {
         ...
         return view('super-admin.message-cases.index', compact('messages'));
     }
