            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="{{ route('lgu.emergencycall.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <div class="d-flex gap-2">
                            <form id="respondedForm-{{ $call->id }}"
                                action="{{ route('lgu.emergencycall.responded', $call->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                            ...
                            <form id="completeForm-{{ $call->id }}"
                                action="{{ route('lgu.emergencycall.complete', $call->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                        ...
                                        <div class="modal fade" id="generateReportModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form
                                                        action="{{ route('lgu.incident_reports.generate.with_source', ['id' => $call->id, 'source_type' => 'call']) }}"
                                                        method="GET">
