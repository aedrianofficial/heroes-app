            ...
            <div class="col-lg-10">
                <div class="card shadow-lg mt-4">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="<?php echo e(route('admin.mho.reports')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.mho', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/mho/report/view.blade.php ENDPATH**/ ?>