            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between">
                        <a href="<?php echo e(route('lgu.emergencycall.index')); ?>" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <div class="d-flex gap-2">
                            <form id="respondedForm-<?php echo e($call->id); ?>"
                                action="<?php echo e(route('lgu.emergencycall.responded', $call->id)); ?>"
                            ...
                            <form id="completeForm-<?php echo e($call->id); ?>"
                                action="<?php echo e(route('lgu.emergencycall.complete', $call->id)); ?>"
                                method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.lgu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/lgu/emergency-calls/view.blade.php ENDPATH**/ ?>