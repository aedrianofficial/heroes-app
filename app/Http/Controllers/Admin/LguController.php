...
class LguController extends Controller
{
    public function lguDashboard()
    {
        ...
        $agencies = Agency::all();
        return view('admin.lgu.dashboard', compact('totalReports', 'pendingReports', 'completedReports','respondedReports', 'reports','agencies'));
    }
    ...
    public function createReport(){
        return view('admin.lgu.report.create');
    }
    ...
    public function emergencyCallList()
    {
        ...
        // Return view with data
        return view('admin.lgu.emergency-calls.index', compact('calls'));
    }
