...
class BfpController extends Controller
{
    public function bfpDashboard()
    {
        ...
        // Fetch reports assigned to bfp (agency_id = 2)
        $reports = Report::whereHas('user', function ($query) {
            $query->where('agency_id', 3); 
        ...
        return view('admin.bfp.dashboard', compact('totalReports', 'pendingReports', 'completedReports','ongoingReports', 'reports'));
    }
    ...
    public function createReport(){
        return view('admin.bfp.report.create');
    }
    ...
    public function emergencyMessageList()
    {
        ...
        return view('admin.bfp.emergency-messages.index', compact('messages'));
    }
    public function viewEmergencyMessage($id)
    {
        ...
        return view('admin.bfp.emergency-messages.view', compact('message'));
    }
