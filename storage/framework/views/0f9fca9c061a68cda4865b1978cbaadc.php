                        ...
                        <tbody>
                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('mdrrmo.reports.view', $report->id)); ?>"
                                            class="btn btn-sm btn-primary">View</a>

                                    </td>
                                    <td>
                                        <form action="<?php echo e(route('mdrrmo.reports.responded', $report->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('mdrrmo.reports.complete', $report->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.mdrrmo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/mdrrmo/report/all-report.blade.php ENDPATH**/ ?>