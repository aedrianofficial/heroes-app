                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    {{-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('coastguard.reports.create') }}">Create a
                                    Report</a>
                            </li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('coastguard.emergencymessage.index') }}">Message
                                    logs</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{ route('coastguard.message_cases.index') }}">Cases</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('coastguard.emergencycall.index') }}">Call
                                    logs</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{ route('coastguard.call_cases.index') }}">Cases</a>
                            </li>
                        </ul>
                    </li>
                    <!--<li class="nav-item">
