...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <div class="card bg-dark text-white hero-section mb-5">
                    <img src="{{ asset('asset/image/safety-tips/background1.jpg') }}" class="card-img hero-image"
                        alt="Emergency Preparedness" style="opacity: 0.6; object-fit: contain; height: 400px;">
                    <div class="card-img-overlay d-flex flex-column justify-content-center text-center">
                        <h1 class="card-title fw-bold">Emergency Safety Guide: Stay Prepared for Any Disaster</h1>
                        <p class="card-text fs-5">Essential tips to keep you and your loved ones safe during emergencies.
                        </p>
                    </div>
                </div>
            </div>
