...
@section('title', 'Heroes App - Emergency Response Platform')
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-center text-md-start">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('register') }}" class="btn btn-danger btn-lg me-3">Get Started</a>
                                <a href="{{ route('safetyguide') }}" class="btn btn-outline-light btn-lg">Safety Guide</a>
                            </div>
                        </div>

                        <!-- Right Column (Logo) -->
                        <div class="col-md-6 text-center">
                            <img src="{{ asset('asset/image/logo.png') }}" alt="Heroes App Logo" class="img-fluid"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-danger btn-lg px-5">Sign Up Now</a>
                </div>
            </div>
        </div>
    </section>
