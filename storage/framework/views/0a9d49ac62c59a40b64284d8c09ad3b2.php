                                ...
                                <tr>
                                    ...
                                    <td class="action-btns" data-label="View">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <div class="d-inline">
                                                <a href="<?php echo e(route('mho.emergencymessage.view', $message->id)); ?>"
                                    ...
                                    <td class="action-btns" data-label="Actions">
                                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                                            <form id="ongoingForm-<?php echo e($message->id); ?>"
                                                action="<?php echo e(route('mho.emergencymessage.ongoing', $message->id)); ?>"
                                            ...
                                            <form id="completeForm-<?php echo e($message->id); ?>"
                                                action="<?php echo e(route('mho.emergencymessage.complete', $message->id)); ?>"
                                                method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="button"
...
<?php echo $__env->make('layouts.mho', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heroes-app\resources\views/admin/mho/emergency-messages/index.blade.php ENDPATH**/ ?>